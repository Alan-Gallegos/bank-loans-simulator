...
namespace Préstamos {
  public partial class FrmAltaPréstamos : Form {
    ...
    private FrmIngreso fi = new FrmIngreso();
    ...
    private void btnAlta_Click(object sender, EventArgs e) {
      ...
      fecha = dtpFecha.Value.ToShortDateString().ToString();     //Recupera la fecha.
      cadSql = $"insert into Préstamos values ({folio},'{fecha}',{fcp.Monto}," +
        $"{fcp.Tasa},{fcp.Plazo},{fcp.Mensualidad},{fcp.PagoTotal},{fcp.PagoTotal},'{rfc}')";
